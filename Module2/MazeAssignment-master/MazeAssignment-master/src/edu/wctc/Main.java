...
Player: A concrete class that contains an int field called score. It also contains a List of Strings called inventory. The Player class contains the following methods.
